from main import opts, steps_list, get_dataset, retrieve_split_points, retrieve_metrics, load_auto_metric
...
if __name__ == "__main__":
    ...
    for step in steps:
        ...
        if step == "final":
            ...
            DEC.steps = step
        DEC.metric(auto_metric=auto_metric)
        if args.verbose:
            DEC.print_memory()
    ...
    DEC.update_json()
    DEC.plot()
    if args.higher_decomposition and args.decomposition_method == "concepts_retrieval" and step == "step480000":
        print("Creating transform json file...")
        DEC.load_dict()
        DEC.create_transform_json()
